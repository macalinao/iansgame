 ...
 * @author simplyianm
 */
public class RenderMapFringeSystem extends EntityProcessingSystem {
    ...
    public RenderMapFringeSystem(MainClient client) {
    ...
    protected void process(Entity entity) {
        ...
        if (lastTileX >= 0 && lastTileY >= 0) {
            map.render(xRenderOffset, yRenderOffset, firstTileX, firstTileY, lastTileX, lastTileY, 4, true);
            map.render(xRenderOffset, yRenderOffset, firstTileX, firstTileY, lastTileX, lastTileY, 5, true);
        }
    }
